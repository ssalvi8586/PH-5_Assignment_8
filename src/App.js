  ...
  return (
    <div className='bodyContainer'>
      ...
      <div>
        ...
        <p>Building web apps with real DOM is slower. Here react comes to rescue. React gives us a virtual DOM. We can use components which React compares with the virtual DOM and the actual dom using diff algorithm. This helps to update the browser DOM most efficiently. Thats how react works and speeds up the whole process.</p>
        <hr/>
